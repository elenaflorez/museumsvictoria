<template>
	<nav>
    <NuxtLink class="logoContainer navitem" to="/">
      <svg viewBox="0 0 95 32" xmlns="http://www.w3.org/2000/svg" class="MVLogo">
      ...
      <h4 class="logoText">COLLECTIONS</h4>
    </Nuxtlink>
    <div class="navitem">
      <p><NuxtLink class="navlink" to="/">
      Placeholder
    </NuxtLink></p>
    </div>
    <div class="navitem">
